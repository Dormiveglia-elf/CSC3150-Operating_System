...
// first, traverse invert_page_table to a entry which's value equals pageid
//    if find, judge if it is valid
//        if valid, return idx
//        if invalid, return -idx
//    if not find, return 0
// Notice: The returned idx is actually +1, in order to better distinguish these
// three cases
